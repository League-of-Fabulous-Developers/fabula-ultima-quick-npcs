...
export class AttackDataModel extends foundry.abstract.DataModel {
    ...
    static defineSchema() {
        ...
        return {
            ...
            range: new StringField({blank: false, nullable: false, choices: ["melee", "ranged"]}),
            ...
            damageType: new StringField({blank: false, nullable: false, choices: Object.keys(CONSTANTS.damageTypes)}),
            targetDefense: new StringField({blank: false, nullable: false, initial: "def", choices: ["def", "mDef"]}),
