...
export class SpellDataModel extends foundry.abstract.DataModel {
    ...
    static defineSchema() {
        ...
        return {
            ...
            costType: new StringField({blank: false, nullable: false, choices: ["total", "perTarget"]}),
            duration: new StringField({blank: false, nullable: false, choices: ["instant", "scene"]}),
            opportunity: new StringField({blank: true, nullable: false}),
            description: new StringField({blank: true, nullable: false}),
            offensive: new EmbeddedDataField(OffensiveSpellDataModel, {nullable: true})
        }
    }
    ...
    toItemData() {
        ...
        return {
            ...
            system: {
                ...
                mpCost: {value: this.costType === "total" ? `${this.cost}` : `${this.cost}xT`},
                target: {value: game.i18n.localize(`QUICKNPC.spell.targets.${this.target}`)},
...
class DamagingSpellDataModel extends foundry.abstract.DataModel {
    static defineSchema() {
        ...
        return {
            ...
            type: new StringField({blank: false, nullable: false, choices: Object.keys(CONSTANTS.damageTypes)}),
        }
    }
