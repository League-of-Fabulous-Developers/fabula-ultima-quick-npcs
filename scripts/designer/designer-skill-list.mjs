    ...
    damageVulnerability: {
        ...
        choices: {
            vulnerability: {
                ...
                options: (model) =>
                    Object.fromEntries(Object.entries(CONSTANTS.damageTypes)
                        .filter(([key]) => {
    ...
    damageAbsorption: {
        ...
        choices: {
            absorption: {
                ...
                options: (model) => {
                    const validAffinities = new Set(["res", "imm"]);
                    return Object.fromEntries(Object.entries(CONSTANTS.damageTypes)
                        .filter(([key]) => {
    ...
    specialized: {
        ...
        choices: {
            specialization: {
                ...
                options: (model, context) => {
                    return ["accuracySpecialization", "magicSpecialization", "opposedCheckSpecialization"].reduce((options, key) => {
                        if (!Customizations.checkApplied(context, key)) {
            ...
            if (specialization === "opposedCheckSpecialization") {
                changes.rules = {
                    opposedCheckSpecialization: {
                        name: game.i18n.localize("QUICKNPC.designer.skill.specialized.choices.specialization.opposedCheckSpecialization.name"),
                        summary: game.i18n.localize("QUICKNPC.designer.skill.specialized.choices.specialization.opposedCheckSpecialization.summary"),
                        description: game.i18n.localize("QUICKNPC.designer.skill.specialized.choices.specialization.opposedCheckSpecialization.summary")
                    }
                }
            }
    ...
    statusEffectImmunity: {
        ...
        choices: {
            status1: {
                ...
                options: (model) => Object.fromEntries(Object.entries(CONSTANTS.statusEffects).filter(([key]) => !model.statusImmunities[key])),
                group: "status"
            },
            status2: {
                options: (model) => Object.fromEntries(Object.entries(CONSTANTS.statusEffects).filter(([key]) => !model.statusImmunities[key])),
