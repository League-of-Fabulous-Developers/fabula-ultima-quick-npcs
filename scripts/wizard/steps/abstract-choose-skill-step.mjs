...
export class AbstractChooseSkillStep extends AbstractStep {
    ...
    constructor(formValues) {
        ...
        this.#choices = Object.fromEntries(Object.entries(formValues)
    ...
    static getTemplateData(formValues, current, context) {
        ...
        const choices = Object.fromEntries(Object.entries(options[selected]?.choices ?? {})
            .filter(([, value]) => {
                return !value.conditional || Object.entries(value.conditional).every(([key, value]) => formValues[`choice.${key}`] === value)
            }));
