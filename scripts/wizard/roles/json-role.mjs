...
export class JsonRole extends Role {
    ...
    constructor(data) {
        ...
        this.#roleSkills = Object.fromEntries(Object.entries(this.#data.roleSkills).map(([key, value]) => ([key, parseSkill(value, this.#data.spellLists)])));
        this.#customizations = Object.fromEntries(Object.entries(this.#data.customizations).map(([key, value]) => ([key, parseSkill(value, this.#data.spellLists)])));
    }
